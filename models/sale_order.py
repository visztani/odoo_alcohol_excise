...
class SaleOrder(models.Model):
    ...
    excise_adomennyiseg_kod = fields.Char(string='Adóm. kód', required = True)
    ...
    excise_jogcimkod = fields.Selection(string='Jogcímkód', selection=JOGCIMKODOK, required = True)
