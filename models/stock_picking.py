...
class StockPicking(models.Model):
    ...
    excise_jogcimkod = fields.Selection(string='Jogcímkód', related='sale_id.excise_jogcimkod', readonly=True, store=True)
    ...
    excise_car_no = fields.Char('Rendszám', related = 'sale_id.excise_car_no', readonly=True, store=True)
