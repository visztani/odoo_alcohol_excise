...
class SaleOrderLine(models.Model):
    ...
    excise_so_line_biztositek = fields.Boolean(string='Biztosíték?', related='product_id.excise_guarantee_needed', readonly=True)
    total_hlf = fields.Float(string='HLF Line', compute='_compute_total_hlf', store=True)
    excise_so_line_fajtakod = fields.Char(string='Fajtakód', related='product_id.excise_fajtakod', readonly=True)
